...
export default class PlanetScaleDriver extends AbstractDriver {
    ...
    public readonly EngineName: string = "PlanetScale";
    ...
    public async GetAllTables(
        ...
        const response: {
            ...
            `SELECT TABLE_SCHEMA, TABLE_NAME, TABLE_SCHEMA as DB_NAME
                        ...
                        AND table_schema IN (${PlanetScaleDriver.buildEscapedObjectList(
                            dbNames
                        )})`
        );
    ...
    public async GetCoulmnsFromEntity(
        ...
        const response = await this.ExecQuery<{
            ...
            FROM INFORMATION_SCHEMA.COLUMNS where TABLE_SCHEMA IN (${PlanetScaleDriver.buildEscapedObjectList(
                dbNames
            )})
        ...
        entities.forEach((ent) => {
            response
                ...
                .forEach((resp) => {
                    ...
                    const defaultValue =
                        PlanetScaleDriver.ReturnDefaultValueFunction(
                            resp.COLUMN_DEFAULT,
                            resp.DATA_TYPE
                        );
    ...
    public async GetIndexesFromEntity(
        ...
        WHERE table_schema IN (${PlanetScaleDriver.buildEscapedObjectList(
            dbNames
        )})`);
    ...
    public async GetRelations(
        ...
        const response = await this.ExecQuery<{
          ...
          WHERE
            TABLE_SCHEMA IN (${PlanetScaleDriver.buildEscapedObjectList(
                dbNames
            )})
        ...
        const retVal = PlanetScaleDriver.GetRelationsFromRelationTempInfo(
            relationsTemp,
            entities,
            generationOptions
        );
        ...
        const promise = new Promise<boolean>((resolve, reject) => {
            try {
                this.connection = connect({
                    ...
                    username: connectionOptons.user,
